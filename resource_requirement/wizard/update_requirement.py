...
class UpdateRequirementWizard(models.TransientModel):
    _name = 'update.requirement.wizard'
    _description = 'Update Requirement Wizard'

    reason = fields.Text(string='Reason')
    start_date = fields.Datetime('Start Date')
    end_date = fields.Datetime('End Date')

    def update_requirement_reason(self):
        self.ensure_one()
