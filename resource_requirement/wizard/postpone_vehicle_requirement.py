...
class PostponeVehicleRequirementWizard(models.TransientModel):
    _name = 'postpone.vehicle.requirement.wizard'
    _description = 'Postpone Vehicle Requirement Wizard'

    reason = fields.Text(string='Reason', required=True)
    number_of_vehicle = fields.Integer(string='Number of Vehicle')

    def postpone_vehicle_requirement_reason(self):
        self.ensure_one()
